...
public class AccountController {
	...
	public List<Account> accountList() {
		...
		List<Account> accountsList = accountManager.getAllAccounts();

		return accountsList; // REPLACE THIS LINE to return a list accounts
	...
	// - Save all work.
	@GetMapping(path = "/accounts/{entityId}")
